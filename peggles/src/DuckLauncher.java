...
public class DuckLauncher extends JComponent {
...
//         setDoubleBuffered(true);
        ...
        setSize(400, 400); // set size of this component
        mouseX = getWidth() /4; // set mouse X-coordinate
        mouseY = getHeight() /4; // set mouse Y-coordinate
        angle = 0;
...
//        frame.setResizable(false);
        ...
        image = readImage("duckinballLAUNCHER.png");
